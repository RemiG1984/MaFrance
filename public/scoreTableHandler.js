    ...
    async function showCountryDetails() {
        try {
            ...
            const rows = [
                ...
                { title: "Homicides et tentatives (pour 100k hab.)", main: `${(crime.homicides_p100k || 0).toFixed(2)} (${crime.annee})`, subRow: true, link: "/crime_graph.html?type=country&code=France" },
                { title: "Violences physiques (pour mille hab.)", main: `${(crime.violences_physiques_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: "/crime_graph.html?type=country&code=France" },
                ...
                { title: "Vols (pour mille hab.)", main: `${(crime.vols_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: "/crime_graph.html?type=country&code=France" },
                { title: "Destruction et dégradations (pour mille hab.)", main: `${(crime.destructions_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: "/crime_graph.html?type=country&code=France" },
                { title: "Trafic et usage de stupéfiants (pour mille hab.)", main: `${(crime.stupefiants_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: "/crime_graph.html?type=country&code=France" },
    ...
    async function showDepartmentDetails(departement) {
        ...
        try {
            ...
            const rows = [
                { title: "Population", main: formatNumber(details.population) },
                { title: "Score Insécurité", main: details.insecurite_score?.toString() || 'N/A' },
                { title: "Homicides et tentatives (pour 100k hab.)", main: `${(crime.homicides_p100k || 0).toFixed(2)} (${crime.annee})`, subRow: true, link: `/crime_graph.html?type=departement&code=${departement}` },
                { title: "Violences physiques (pour mille hab.)", main: `${(crime.violences_physiques_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: `/crime_graph.html?type=departement&code=${departement}` },
                ...
                { title: "Vols (pour mille hab.)", main: `${(crime.vols_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: `/crime_graph.html?type=departement&code=${departement}` },
                { title: "Destruction et dégradations (pour mille hab.)", main: `${(crime.destructions_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: `/crime_graph.html?type=departement&code=${departement}` },
                { title: "Trafic et usage de stupéfiants (pour mille hab.)", main: `${(crime.stupefiants_p1k || 0).toFixed(1)} (${crime.annee})`, subRow: true, link: `/crime_graph.html?type=departement&code=${departement}` },
