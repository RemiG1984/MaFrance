...
const MetricsConfig = {
    ...
    metrics: [
        ...
        },
        {
            ...
            label: "Naturalisés (%)",
            alt1Label: "Naturalisés (%)",
            alt2Label: "Naturalisés (%)",
            category: "immigration",
            format: "percentage",
            source: "nat1",
        },
        ...
        },
        {
            ...
            label: "Maghrebins et Turcs (%)",
            alt1Label: "Maghrebins et Turcs (%)",
            alt2Label: "Maghrebins et Turcs (%)",
            category: "immigration",
            format: "percentage",
            source: "nat1",
        },
        ...
        },
        {
            ...
            alt1Label: "Autres nationalités (%)",
            alt2Label: "Autres nationalités (%)",
            category: "immigration",
            format: "percentage",
            source: "nat1",
        },
        {
            ...
            label: "Non-européens (%)",
            alt1Label: "Non-européens (%)",
            alt2Label: "Non-européens (%)",
            category: "immigration",
            format: "percentage",
            source: "nat1",
        },
